...
public class App {
	...
	public void addEmployee() {
		...
		try {
			...
			fail("Users able to enter demo details Failed");
			e.printStackTrace();
			System.out.println("Users able to enter demo details Failed.");
		} 
	...
	/**
	 *  Clicks the submit button of the add demo UI
	 * 
	 */
	...
	/**
	 *  Method validates the new demo data has been added to the Benefits Dashboard table.
	 *  The data is hard coded that is entered so the method validate page content agasint
	 *  declared Constants.
	 * 
	 */
	public void seeEmployeeInTable() {
		//Gets text of First and Last name to be compared to what was entered in add demo
		...
		try {			
			...
			if (firstResult.equals(FIRST) && lastResult.equals(LAST)){
				System.out.println("Expected Result Returned, the user should see the demo "+ firstResult + " "
						+ lastResult +" in the table");
			}else{
				fail("Expected Result Was NOT Returned, the user should see the demo in the table Has Failed");
				System.out.println("Expected Result Was NOT Returned, the user should see the demo in the table Has Failed");
			}
	...
	public void seeCorrectCalculations() {
		//Gets text of Benefit Cost and Net Pay to be compared to what was entered in add demo
